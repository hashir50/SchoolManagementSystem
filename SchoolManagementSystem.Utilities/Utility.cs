...
namespace SchoolManagementSystem.Utilities
{
    public class Utility
    {
        ...
        //public async static Task<string> SaveMedia(IWebHostEnvironment environment, IFormFile media)
        //{

        //    string directoryPath = Path.Combine(environment.WebRootPath, "Gallery");
